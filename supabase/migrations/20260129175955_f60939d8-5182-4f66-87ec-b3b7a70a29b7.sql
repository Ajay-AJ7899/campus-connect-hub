-- Allow campus creation during pre-auth signup flows (called from the login screen)
...
GRANT EXECUTE ON FUNCTION public.create_campus(text, text, text, text) TO anon;
